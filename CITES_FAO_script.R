...
#3. Combine data from each questionnaire by species-question number
...
#4. Analyse each question by species
setwd('C:\\Matias\\FAO')
...
if(do.mean)
{
  ...
  write.csv(Flat.tab.fal,"C:/Matias/FAO/outputs/Paper/MeanScore_and_reviewer/Scores_flat_table_fal.csv",row.names=F)
  write.csv(Flat.tab.thr,"C:/Matias/FAO/outputs/Paper/MeanScore_and_reviewer/Scores_flat_table_thr.csv",row.names=F)
